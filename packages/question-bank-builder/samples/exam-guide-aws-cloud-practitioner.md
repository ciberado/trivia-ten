...
implementation, and/or operations. The candidate might be in the early stages of
pursuing an AWS Cloud career or the candidate might work with people in AWS Cloud
roles.
...
*  Identifying encryption options (for example, encryption in transit,
encryption at rest)
...
Skills in:
*  Describing AWS security features and services (for example, AWS WAF, AWS
Firewall Manager, AWS Shield, Amazon GuardDuty)
...
Skills in:
*  Recognizing the appropriate use of various EC2 instance types (for example,
compute optimized, storage optimized)
*  Recognizing the appropriate use of various container options (for example,
Amazon ECS, Amazon EKS)
*  Recognizing the appropriate use of various serverless compute options (for
example, AWS Fargate, Lambda)
*  Recognizing that auto scaling provides elasticity
Version 1.2 CLF-C02 8 | PAGE
...
Skills in:
*  Understanding AI/ML services and the tasks that they accomplish (for
example, Amazon SageMaker AI, Amazon Lex, Amazon Kendra)
...
Version 1.2 CLF-C02 11 | PAGE
Skills in:
*  Understanding the appropriate uses and capabilities of AWS Budgets, and
AWS Cost Explorer
...
*  Cost management
*  Databases
*  Amazon EC2 instance types (for example, Reserved Instances, On-Demand
...
Robotics:
*  AWS RoboMaker
Version 1.2 CLF-C02 22 | PAGE
Storage:
Amazon FSx for Lustre
Version 1.2 CLF-C02 23 | PAGE
